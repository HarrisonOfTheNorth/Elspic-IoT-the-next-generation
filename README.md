...
A prevailing characteristic of electronically conspicuous data being linear, tangental, or perpendicular, is that the electronically conspicuous data source may not know which of these three categories that it's data is considered to be, *as consumed by a particular observer*.
